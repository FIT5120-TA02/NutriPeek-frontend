...
import { Trash2, ChevronDown, ChevronUp, Plus, BarChart2, LightbulbIcon, Printer } from 'lucide-react';
  ...
  return (
    <>
      ...
      >
        ...
        {/* Print button */}
        <button
          className="absolute top-3 right-10 text-gray-500 hover:text-gray-700 z-10 p-1 rounded-full hover:bg-gray-50"
          onClick={handlePrint}
        >
          <Printer size={18} />
        </button>
